...
\begin{figure}[h!]
  \includegraphics[totalheight=1cm]{images/android.eps}
  \includegraphics[totalheight=1cm]{images/c.eps}
  \includegraphics[totalheight=1cm]{images/cpp.eps}
  \includegraphics[totalheight=1cm]{images/css.eps}
  \includegraphics[totalheight=1cm]{images/html.eps}
  \includegraphics[totalheight=1cm]{images/laravel.eps}
  \includegraphics[totalheight=1cm]{images/php.eps}
  \includegraphics[totalheight=1cm]{images/python.eps}
  \includegraphics[totalheight=1cm]{images/MySQL.eps}
  \includegraphics[totalheight=1cm]{images/java.eps}
  \includegraphics[totalheight=1cm]{images/sqlite.eps}
  \includegraphics[totalheight=1cm]{images/psql.eps}
  \includegraphics[totalheight=1cm]{images/ocaml.eps}
  \includegraphics[totalheight=1cm]{images/javascript.eps}
  \includegraphics[totalheight=1cm]{images/Qt.eps}
  \includegraphics[totalheight=1cm]{images/blender.eps}
  \includegraphics[totalheight=1cm]{images/git.eps}
  \includegraphics[totalheight=1cm]{images/svn.eps}
...
\cvdoubleitem{category 1}{C, C++}{category 4}{XXX, YYY, ZZZ}
\cvdoubleitem{category 2}{PHP, python}{category 5}{XXX, YYY, ZZZ}
\cvdoubleitem{category 3}{Java, Android}{category 6}{XXX, YYY, ZZZ}
